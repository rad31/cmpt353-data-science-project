...
def main():
    ...
    X = economic_data.drop(columns=['state', 
                                ...
                                'total_percent_hosp',
                                'percent_vaccinated'])
    y = economic_data['percent_vaccinated']
...
# Pretty consistent, MAE=0.054, MSE=0.0047
