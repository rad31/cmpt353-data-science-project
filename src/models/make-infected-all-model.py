...
def main():
    ...
    X = all_data.drop(columns=['state', 
                                ...
                                'total_percent_hosp',
                                'percent_vaccinated'])
    y = all_data['total_percent_infected']
...
# Not as consistent, MAE=0.042, MSE=0.0022
def get_svr_model():
    return make_pipeline(
